(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    0: function (e, t, n) {
        ...
        var a = n("2b0e"), i = n("2f62"), o = (n("b0c0"), {
            ...
            }, m = {namespaced: !0, state: u, mutations: l, actions: d}, f = n("83d6"), h = n.n(f), p = h.a.showSettings,
            v = h.a.fixedHeader, b = h.a.sidebarLogo, g = {showSettings: p, fixedHeader: v, sidebarLogo: b}, w = {
            ...
            }, y = {namespaced: !0, state: g, mutations: w, actions: x}, k = (n("d3b7"), n("498a"), n("b775"));

        function C(e) {
            return Object(k["a"])({url: "/admin_login", method: "post", data: e})
        }

        function _() {
            return Object(k["a"])({url: "/logout", method: "post"})
        }

        var S = n("5f87"), O = n("a18c"), E = function () {
            return {token: Object(S["a"])(), name: "", avatar: ""}
        }, T = E(), H = {
            ...
            login: function (e, t) {
                var n = e.commit, a = t.adminname, i = t.password;
                return new Promise((function (e, t) {
                    C({adminname: a.trim(), password: i}).then((function (t) {
                        console.log(t), console.log(1);
                        var a = t.data, i = t.msg, o = t.status;
                        console.log(a, i, o), n("SET_TOKEN", a.data.token), Object(S["c"])(a.token);
                        var r = a.name, s = a.avatar;
                        n("SET_NAME", r), n("SET_AVATAR", s), e(a), e()
                    })).catch((function (e) {
                        console.log(1), t(e)
                    }))
                }))
                ...
                return new Promise((function (e, a) {
                    (void 0)(n.token).then((function (n) {
                        var i = n.data;
                ...
                var t = e.commit, n = e.state;
                return new Promise((function (e, a) {
                    _(n.token).then((function () {
                        Object(S["b"])(), Object(O["b"])(), t("RESET_STATE"), e()
                    })).catch((function (e) {
                        a(e)
                    }))
                }))
                ...
                return new Promise((function (e) {
                    Object(S["b"])(), t("RESET_STATE"), e()
                }))
            }
        }, M = {namespaced: !0, state: T, mutations: H, actions: z};
        a["default"].use(i["a"]);
        var B = new i["a"].Store({modules: {app: m, settings: y, user: M}, getters: r});
        t["a"] = B
    }, "47f1": function (e, t, n) {
        "use strict";
        n.r(t);
        ...
        var a = n("2b0e"), i = (n("f5df1"), n("5c96")), o = n.n(i), r = (n("0fae"), n("b2d6")), s = n.n(r),
            c = n("313e"), u = n.n(c), l = (n("b20f"), function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {attrs: {id: "app"}}, [n("router-view")], 1)
            }), d = [], m = {
                name: "App", mounted: function () {
                    console.log(1);
                    var e = JSON.parse(sessionStorage.getItem("adminInfo"));
                    e || this.$router.push("/login")
                }
            }, f = m, h = n("2877"), p = Object(h["a"])(f, l, d, !1, null, null, null), v = p.exports, b = n("4360"),
            g = n("a18c"), w = (n("d81d"), n("d3b7"), n("ddb0"), function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                ...
                computed: {
                    isExternal: function () {
                        return Object(y["a"])(this.iconClass)
                    }, iconName: function () {
            ...
            }, C = k, _ = (n("68fa"), Object(h["a"])(C, w, x, !1, null, "f9f7fefc", null)), S = _.exports;
        a["default"].component("svg-icon", S);
        var O = n("51ff"), E = function (e) {
            return e.keys().map(e)
        };
        E(O);
        var T = n("1da1"), H = (n("96cf"), n("323e")), z = n.n(H), M = (n("a5d8"), n("5f87"), n("99af"), n("83d6")),
            B = n.n(M);
        B.a.title;
        z.a.configure({showSpinner: !1});
        g["a"].beforeEach(function () {
            var e = Object(T["a"])(regeneratorRuntime.mark((function e(t, n, a) {
                var i;
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            ...
                            })) ? (i = sessionStorage.getItem("adminInfo"), console.log(i), i ? a() : (console.log(1), alert(0), a({
                                path: "/login",
            ...
            z.a.done()
        })), a["default"].prototype.$echarts = u.a;
        var A = n("4b0f"), j = A.mockXHR;
        j(), a["default"].use(o.a, {locale: s.a}), a["default"].config.productionTip = !1, new a["default"]({
            el: "#app",
            router: g["a"],
            store: b["a"],
            render: function (e) {
        ...
        e.exports = {title: "Vue Admin Template", fixedHeader: !1, sidebarLogo: !0}
    }, "8a60": function (e, t, n) {
        function a(e) {
        ...
        var a, i, o = n("2b0e"), r = n("8c4f"), s = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {
                ...
                return n("div", {staticClass: "navbar"}, [n("hamburger", {
                    ...
                    attrs: {slot: "dropdown"},
                    slot: "dropdown"
                }, [n("router-link", {attrs: {to: "/"}}, [n("el-dropdown-item", [e._v(" Home ")])], 1), n("el-dropdown-item", {
                    attrs: {divided: ""},
                    nativeOn: {
                        click: function (t) {
                            return e.logout(t)
                ...
                }, [n("span", {staticStyle: {display: "block"}}, [e._v("退出")])])], 1)], 1)], 1)], 1)
            }, l = [], d = n("1da1"), m = n("5530"), f = (n("96cf"), n("bc3a")), h = n.n(f), p = n("2f62"),
            v = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, b = [], g = (n("4de4"), n("99af"), n("b0c0"), n("498a"), n("bd11")), w = n.n(g), x = {
                data: function () {
            ...
            }, y = x, k = (n("34c8"), n("2877")), C = Object(k["a"])(y, v, b, !1, null, "62cc9144", null), _ = C.exports,
            S = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {
            ...
            }, T = E, H = (n("186a"), Object(k["a"])(T, S, O, !1, null, "49e15297", null)), z = H.exports, M = {
                components: {Breadcrumb: _, Hamburger: z},
                computed: Object(m["a"])({}, Object(p["b"])(["sidebar", "avatar"])),
                methods: {
                        ...
                        return Object(d["a"])(regeneratorRuntime.mark((function t() {
                            ...
                            return regeneratorRuntime.wrap((function (t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        console.log(1), JSON.parse(sessionStorage.getItem("adminInfo")) && (n = JSON.parse(sessionStorage.getItem("adminInfo")).data.token, h()({
                                            url: "/dev/logout",
                                            method: "post",
                                            data: {token: n}
                                        }).then((function (t) {
                                            console.log(t), e.$message.success(t.data.msg), e.$router.push({path: "/login"}), sessionStorage.setItem("adminInfo", "")
                                        })));
                                    case 2:
                                    case"end":
                                        return t.stop()
            ...
            }, B = M, A = (n("d812"), Object(k["a"])(B, u, l, !1, null, "8f746e48", null)), j = A.exports, L = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                ...
                }, e._l(e.permissionList, (function (e) {
            ...
            }, R = N, D = (n("f5d8"), Object(k["a"])(R, V, I, !1, null, "31c61418", null)), P = D.exports, q = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, G = [], J = n("df7c"), X = n.n(J), U = n("61f7"), F = (n("caad"), n("2532"), {
                name: "MenuItem",
                functional: !0,
            ...
            }), K = F, W = (n("bf4f"), Object(k["a"])(K, a, i, !1, null, "18eeea00", null)), Y = W.exports,
            Q = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, te = ee, ne = Object(k["a"])(te, Q, Z, !1, null, null, null), ae = ne.exports, ie = {
                computed: {
                    device: function () {
                ...
                methods: {
                    hasOneShowingChild: function () {
                        ...
                        return Object(U["a"])(e) ? e : Object(U["a"])(this.basePath) ? this.basePath : X.a.resolve(this.basePath, e)
                    }
                }
            }, re = oe, se = Object(k["a"])(re, q, G, !1, null, null, null), ce = se.exports, ue = n("cf1e"), le = n.n(ue),
            de = {
                components: {SidebarItem: ce, Logo: P},
                computed: Object(m["a"])(Object(m["a"])({}, Object(p["b"])(["sidebar"])), {}, {
                    routes: function () {
                        return console.log(this.$router.options.routes), this.$router.options.routes
                    }, permissionList: function () {
                        var e = JSON.parse(sessionStorage.getItem("adminInfo")), t = e.data.permission;
            ...
            }, me = de, fe = Object(k["a"])(me, L, $, !1, null, null, null), he = fe.exports, pe = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, ge = be, we = (n("e4de"), n("028b"), Object(k["a"])(ge, pe, ve, !1, null, "64cf4d83", null)),
            xe = we.exports, ye = n("4360"), ke = document, Ce = ke.body, _e = 992, Se = {
                watch: {
                    $route: function (e) {
                        "mobile" === this.device && this.sidebar.opened && ye["a"].dispatch("app/closeSideBar", {withoutAnimation: !1})
                    }
                    ...
                    e && (ye["a"].dispatch("app/toggleDevice", "mobile"), ye["a"].dispatch("app/closeSideBar", {withoutAnimation: !0}))
                }, methods: {
                    $_isMobile: function () {
                        ...
                        if (!document.hidden) {
                            var e = this.$_isMobile();
                            ye["a"].dispatch("app/toggleDevice", e ? "mobile" : "desktop"), e && ye["a"].dispatch("app/closeSideBar", {withoutAnimation: !0})
                        }
                    }
                }
            }, Oe = {
                name: "Layout",
                components: {Navbar: j, Sidebar: he, AppMain: xe},
                mixins: [Se],
                computed: {
                    sidebar: function () {
            ...
            }, Ee = Oe, Te = (n("9f2b"), Object(k["a"])(Ee, s, c, !1, null, "4f739cf0", null)), He = Te.exports;
        o["default"].use(r["a"]);
        var ze = [{
            path: "/login", component: function () {
                return n.e("chunk-6af0f9da").then(n.bind(null, "9ed6"))
            }, hidden: !0
        }, {
            ...
            children: [{
                path: "dashboard", name: "Dashboard", component: function () {
                    return n.e("chunk-5088bd5d").then(n.bind(null, "9406"))
                }, meta: {title: "519后台管理", icon: "el-icon-setting"}
            }]
        }, {
            path: "/student",
            component: He,
            ...
            children: [{
                path: "table", name: "Table", component: function () {
                    return n.e("chunk-99b52264").then(n.bind(null, "90fe"))
                }, meta: {icon: " x", title: "学员考勤"}
            }, {
                path: "table2", name: "Table2", component: function () {
                    return n.e("chunk-c2fc56e0").then(n.bind(null, "f30a"))
                }, meta: {icon: " x", title: "学员列表"}
            }, {
                path: "apply", name: "Apply", component: function () {
                    return n.e("chunk-2d0ea0f0").then(n.bind(null, "8fd0"))
                }, meta: {icon: " x", title: "申请列表"}
            }, {
                path: "send", name: "Send", component: function () {
                    return n.e("chunk-2d21af16").then(n.bind(null, "be52"))
                }, meta: {icon: " x", title: "发送邮箱"}
            }, {
                path: "details", name: "Details", component: function () {
                    return n.e("chunk-3880180c").then(n.bind(null, "cfeb"))
                }, meta: {icon: "x ", title: "学员签到详情"}, hidden: !0
            }, {
                path: "echarts", name: "Echarts", component: function () {
                    return n.e("chunk-91e1939e").then(n.bind(null, "1e75"))
                }, meta: {icon: "x ", title: "范围查询"}, hidden: !0
            }, {
                path: "detailsEcharts", name: "detailsEcharts", component: function () {
                    return n.e("chunk-983e81e2").then(n.bind(null, "5f2a"))
                }, meta: {icon: "x ", title: "学员签到详情echarts版本"}, hidden: !0
            }, {
                path: "perInfo", name: "perInfo", component: function () {
                    return n.e("chunk-53562ef0").then(n.bind(null, "465d"))
                }, meta: {icon: "x ", title: "学员签到详情"}, hidden: !0
            }, {
                path: "warnInfo", name: "warnInfo", component: function () {
                    return n.e("chunk-8d14556c").then(n.bind(null, "de19"))
                }, meta: {icon: "x ", title: "可疑数据"}
            }, {
                path: "addAdmin", name: "addAdmin", component: function () {
                    return n.e("chunk-2a4a71e8").then(n.bind(null, "feb6"))
                }, meta: {icon: "x ", title: "添加管理员"}
            }]
        }, {path: "*", redirect: "/404", hidden: !0}], Me = function () {
            return new r["a"]({
        ...
        "use strict";
        n("d3b7");
        var a = n("bc3a"), i = n.n(a), o = n("5c96"), r = n("4360"), s = n("5f87"),
            c = i.a.create({baseURL: "", timeout: 5e3});
        c.interceptors.request.use((function (e) {
            return console.log(e), r["a"].getters.token && (e.headers["X-Token"] = Object(s["a"])()), e
        }), (function (e) {
            return console.log(e), Promise.reject(e)
        })), c.interceptors.response.use((function (e) {
            var t = e.data;
            return 2e4 !== t.code ? (Object(o["Message"])({
